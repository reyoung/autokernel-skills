...
2. 使用 [autotune-tools](../autotune-tools/SKILL.md) 从用户仓库 HEAD 初始化 workspace，通过 stdin 传入非空的用户原始请求并保存到 `user_prompt.md`；baseline 文件保存该 SHA，best worktree 作为后续优化的起点。
